...
public class RecordConverter {
    ...
    public RecordConverter(String specifiedKeyFieldNames, String keyDelimiter, boolean useRecordKeyAsRedisKey) {
    ...
    private RedisRecord getOutputData(Object recordKey, Map<String, Object> recordValue) {
        if (useRecordKeyAsRedisKey) {
            ...
            return new RedisRecord(redisKey, recordValue);
        }
        else {
            ...
            return new RedisRecord(redisKey, redisValue);
        }
    }
